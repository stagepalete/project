    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(default='3 Часа', max_length=29)),
                ('age_restriction', models.CharField(choices=[('12+', '12+'), ('16+', '16+'), ('18+', '18+'), ('21+', '21+')], max_length=29)),
                ('slug', models.SlugField()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labels', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.label')),
            ],
        ),
        migrations.CreateModel(
            name='ArtistGallery',
            fields=[
                ...
                ('band', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='music.band')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', ckeditor.fields.RichTextField(blank=True)),
                ('released', models.DateField()),
                ('recorder', models.CharField(max_length=30)),
                ('length', models.TimeField()),
                ('producer', models.CharField(max_length=100)),
                ('slug', models.SlugField()),
                ('artist', models.ManyToManyField(to='music.artist')),
